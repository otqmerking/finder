...
function createWindow() {
    ...
    // Load main URL
    mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/login.php');
    ...
    const menuTemplate = [
        {
            ...
            submenu: [
                {
                    label: '🏠 Home',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/index.php')
                },
                { role: 'quit', label: '🚪 Exit' },
                {
                    label: '🔒 Sign out',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/logout.php')
                },
            ]
        },
        {
            ...
            submenu: [
                {
                    label: '🧰 Tech',
                    click: () => mainWindow.loadURL('http://dlbsxk8q3.aptivv.com/Finder/resources/app/tech/tech.html')
                },
                {
                    label: '📦 Stock Manager',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/stock/admin.php')
                },
                {
                    label: '📭 No Inventory',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/noinvo.php')
                },
                {
                    label: '🛒 Orders',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/order/notifications.php')
                },
                {
                    label: '📚 Catalogs',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/pdf/pdf.php')
                },
                {
                    label: '⚙️ Consumption',
                    submenu: [
                        {
                            label: '📊 Analytics',
                            click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/consumption/consumption.html')
                        },
                        {
                            label: '🕒 History',
                            click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/history.html')
                        }
                    ]
                },
                {
                    ...
                    submenu: [
                        {
                            label: '📹 Videos',
                            click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/video.php')
                        },
                        {
                            label: '🧊 Models',
                            click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/model.php')
                        }
                    ]
                },
                {
                    label: '🚚 Supplier',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/supplier.php')
                }
            ]
        },
        {
            ...
            submenu: [
                {
                    label: '👨‍💻 Developer',
                    click: () => mainWindow.loadURL('https://dlbsxk8q3.aptivv.com/Finder/resources/app/cv.pdf')
                },
            ]
        },
        {
